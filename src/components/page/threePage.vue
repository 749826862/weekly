  ...
  .two_main
    ...
    .message
      .title_1
        ...
        zhutuzhexian.auto(:className="'gedanweipeibian'")
        p 
        ...
        zhutuzhexian.auto(:className="'gedanweiyichang'")
        p 
        ...
        zhutuzhexian.auto(:className="'gedanweiyanzhong'")
        ...
        zhutuzhexian.auto(:className="'gedanweipeidianya'")
        p 
        ...
        zhutuzhexian.auto(:className="'peidianyicahng'")
        p 
        ...
        zhutuzhexian.auto(:className="'peidianshichang'")
        ...
        zhutuzhexian.auto(:className="'gedanweibukejiance'")
        p 
        ...
        zhutuzhexian.auto(:className="'bukejiancezhou'")
        p 
        ...
        zhutuzhexian.auto(:className="'xinzengbuke'")
        p 
        ...
        zhutuzhexian.auto(:className="'bukejianceyuanyin'")
        p 
        ...
        zhutuzhexian.auto(:className="'bukejiancefenxi'")
        p 
        ...
        zhutuzhexian.auto(:className="'xintouyunfenxi'")
        ...
        zhutuzhexian.auto(:className="'gongsipeidianqishi'")
        p 
          span.word_content 从单位分布上看，重过载数占总量比较高的三家单位分别为大兴、怀柔、门头沟公司。
        zhutuzhexian.auto(:className="'gedanweizhongzai'")
        p 
